...
class EventHandler(BaseHandler):
    portal_types = ('ATEvent', 'Event')
    ident = 'event'

    def export2(self, obj):
        
        # especific fields os Event
        self.write('location ', obj.getLocation())
...
class BannerHandler(BaseHandler):
    ...
    def export2(self, obj):
        data = obj.getSource()
        self.write_binary(str(data))    

registerHandler(BannerHandler)
