...
Este script é usado para formatar e validar campos de data. No final
desse arquivo tem um trecho html demonstrando como utilizá-lo. Copie
o trecho e cole em algum template para testá-lo.
...
function DateFormat(vDateName, vDateValue, e, dateCheck, dateType) {
	...
	if (whichCode == 8) //Ignore the Netscape value for backspace. IE has no value
		...
		if (strCheck.indexOf(whichCode) != -1) {
			...
			{
				//  Luiz: comentei esta linha, pois estava causando problema(retirando um digito
				//	da data)
				//vDateName.value = vDateName.value.substr(0, (vDateValue.length-1));
				return false;
	        }
