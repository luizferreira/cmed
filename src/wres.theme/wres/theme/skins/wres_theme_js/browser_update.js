...
// Get by Communimed in 10/09/2012.
/*
EDITED BY COMMUNIMED:
Always will be in pt.
Always will open in new window (_blank)
Text edited
*/
...
if (languages.indexOf(ll)!==false)
    this.op.url="http://browser-update.org/pt/update.html#"+jsv;
var tar="";
tar=' target="_blank"'; // edited by CommuniMed (always will be _blank)
...
var t = 'Seu navegador (%s) está <b>desatualizado</b>. Ele possui <b>falhas de segurança</b> e provavelmente <b>apresentará problemas</b> para exibir algumas funcionalidades do CommuniMed. <a%s>Veja como atualizar o seu navegador</a>';
...
background:#FDF2AB no-repeat 10px center url(./dialog-warning.gif);\
