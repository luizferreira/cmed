...
#===============================================================================
# Definição dos schemas de do tipo ProgressNotes
#===============================================================================
...
ASSESSMENT = Schema((
    ...
    DataGridField('diagnosis',
            columns=('description', 'code', 'date', 'status'),
            allow_empty_rows = False,
            allow_oddeven=True,
            widget = DataGridWidget(
                label='Diagnóstico',
...
ProgressNotesSchema = MedicalDocumentSchema + SUBJECTIVE + OBJECTIVE + ASSESSMENT + PLANS 
