...
class Validation(object):
    ...
    def counters_validator(self, section):
        ...
        # vocabs
        vocabs = {
            'document_types': self.cfg.get(section, 'vocab_document_types_counter'),
            'impresso_types': self.cfg.get(section, 'vocab_impresso_types_counter'),
            'visit_types': self.cfg.get(section, 'vocab_visit_types_counter'),
            'visit_reason': self.cfg.get(section, 'vocab_visit_reason_counter'),
...
if __name__ == '__main__':
    ...
    for import_dir in args:
        ...
        transaction.commit()
        print 'done'
        Validation(cmed_instance, import_dir)
        print cmed_instance.absolute_url()
